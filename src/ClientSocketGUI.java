...
public class ClientSocketGUI {
	...
	public JTextField txtInputaddress;
	public JTextField txtInputport;
	...
	private void initialize() {
		...
		btnRun.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
					...
					//txtInputaddress.requestFocusInWindow();
					
				
					String s = txtInputaddress.getText();
		...
		*/
		...
		txtInputaddress.setBackground(Color.BLACK);
		txtInputaddress.setFont(new Font("Dialog", Font.BOLD, 12));
		txtInputaddress.setForeground(Color.GREEN);
		txtInputaddress.setHorizontalAlignment(SwingConstants.LEFT);
		txtInputaddress.setBounds(12, 12, 12, 12);
		frame.getContentPane().add(txtInputaddress);
		txtInputaddress.setColumns(5);
		
		txtInputport = new JTextField();
		txtInputport.setBackground(Color.BLACK);
		txtInputport.setFont(new Font("Dialog", Font.BOLD, 12));
		txtInputport.setForeground(Color.GREEN);
		txtInputport.setHorizontalAlignment(SwingConstants.LEFT);
		txtInputport.setBounds(12, 12, 12, 12);
		frame.getContentPane().add(txtInputport);
		txtInputport.setColumns(5);
